            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="normal__breadcrumb__text">
                        <h2>Cadastro</h2>
                        <p>Preencha seus dados principais!</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="login__form">
                        ...
                        <form action="#">
                            ...
                            <button type="submit" class="site-btn">Faça Login</button>
                        </form>
                        <h5>Já tem conta? <a href="login.html">Login!</a></h5>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login__social__links">
                        <h3>Entre com:</h3>
                        <ul>
                            <li><a href="#" class="facebook"><i class="fa fa-facebook"></i> Entre com Facebook</a></li>
                            <li><a href="#" class="google"><i class="fa fa-google"></i> Entre com Google</a></li>
                            <li><a href="#" class="twitter"><i class="fa fa-twitter"></i> Entre com Twitter</a></li>
                        </ul>
                    </div>
                </div>
            </div>
