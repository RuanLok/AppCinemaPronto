            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="normal__breadcrumb__text">
                        <h2>Login</h2>
                        <p>Cadastre-se ou informe seu e-mail e senha para prosseguir com a compra.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login__register">
                        <h3>Não tem Conta?</h3>
                        <a href="signup.html" class="primary-btn">Registre-se agora</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="login__social__links">
                            ...
                            <ul>
                                ...
                                <li><a href="#" class="twitter"><i class="fa fa-twitter"></i> Entre com Twitter</a>
                                </li>
                            </ul>
                        </div>
                    </div>
